...
extern "C" {
#endif
extern void rosette_run_snax86_core(void);
...
{
    (void)arg;
    rosette_run_snax86_core();
}

int main(int argc, char **argv)
{
    rosette_debug_bootstrap_from_argv((argc > 0) ? argv[0] : NULL);
    printf("Rosette: Launching snax86 windowed...\n");
    /* Screen is 60 columns x 20 rows defined by the game */
    rosette_windowed_run(60, 20, 0, 0, "Snake (Windowed)", game_thread, NULL);
    return 0;
}
