...
bool rosette_gfx_scene_get_rect(unsigned int index, void *out_rect) {
    (void)index;
    (void)out_rect;
    return 0;
}

bool rosette_gfx_scene_get_text(unsigned int index, void *out_text) {
    (void)index;
    (void)out_text;
    return 0;
}
