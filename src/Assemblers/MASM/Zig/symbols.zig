...
pub const Symbol = struct {
    name: []const u8 = "",
    kind: masm.SymbolType = .undefined,
    value: u64 = 0,
    segment_index: u32 = std.math.maxInt(u32),
    offset: u64 = 0,
    size: u32 = 0,
    scope: masm.ScopeType = .global,
    defined: bool = false,
    used: bool = false,
    pass_defined: u16 = 0,
...
pub const SymbolTable = struct {
    ...
    pub fn define(self: *SymbolTable, name: []const u8, kind: masm.SymbolType, value: u64, seg_idx: u32, offset_val: u64, size: u32) !void {
...
pub const ProcStack = struct {
    ...
    pub fn push(self: *ProcStack, allocator: Allocator, name: []const u8, seg_idx: u32, offset: u64) !void {
...
test "symbol define and lookup" {
    ...
    try st.define("test_var", .variable, 0, 0, 0x100, 4);
...
test "symbol redefinition" {
    ...
    try st.define("x", .constant, 10, std.math.maxInt(u32), 0, 0);
    try st.define("x", .constant, 20, std.math.maxInt(u32), 0, 0);
